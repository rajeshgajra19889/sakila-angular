...
export const routes: Routes = [
    { path: 'login', loadComponent: () => import('./features/login/login-page').then(m => m.LoginPage) },
    {
        ...
        children: [
            ...
            { path: 'stores/comparison', loadComponent: () => import('./features/stores/store-comparison-page').then(m => m.StoreComparisonPage) },
            ...
            { path: 'staffs/performance', loadComponent: () => import('./features/staffs/staff-performance-page').then(m => m.StaffPerformancePage) },
